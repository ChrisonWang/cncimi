...
$sql = "INSERT INTO `#@__classadvice` (a1, a2, a3, a4, a5,a6,a7,a8,shijian) VALUES ('$a1', '$a2', '$a3', '$a4', '$a5', '$a6', '$a7', '$a8', '$posttime')";
					if($dosql->ExecNoneQuery($sql))
					{
						ShowMsg('课程建议提交成功，工作人员会在3个工作日内与您电话确认！','index.php');
						exit();
					}
}
?>
        	...
        	<div class="login-box">
            	...
            	<div class="login-box-l" style="border:0;width:100%">
                	...
                	<ul class="form">
                        ...
                        <li>
                            <span class="f">选择类别<font style="color:#f00">*</font></span>
                            <select name="a7" >
                            	<option value="医药技术培训">医药技术培训</option>
                            	<option value="医械技术培训">医械技术培训</option>
                            	<option value="食品安全培训">食品安全培训</option>
                            </select>
                        </li>
                        <li>
                            <span class="f">建议信息<font style="color:#f00">*</font></span>
                            <textarea class="need" name="a8" ></textarea>
                            <samp>请输入建议信息</samp>
                            <div class="clear"></div>
                        </li>
