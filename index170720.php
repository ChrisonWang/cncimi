...
<?php require_once('head.php'); ?>
    ...
    <div class="center-l pull-left">
        ...
        <div class="index-box" style="margin-left:0px;width:auto">
        	<div class="index-box-wrap" style=" height:432px">
        		<div class="index-box-t clearfix">
                    <a href="<?php echo Getclass(46,1);?>" class="more2"></a>
                    <span style="background-position:0px -650px">药典订购</span>
                </div>
                <div class="index-box-c" style="padding:0">
                    <ul class="yd">
                    <?php echo GetYdclass(29);?>
        ...
        <div class="func-div mt10" style="height:168px">
