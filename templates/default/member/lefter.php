...
<div class="act"> 
<a href="?c=default" <?php if($c=='default') echo 'class="on"'; ?>>个人中心</a> 
<a href="?c=edit" <?php if($c=='edit' or $c=='avatar') echo 'class="on"'; ?>>编辑资料</a> 
<a href="?c=favorite" <?php if($c=='favorite') echo 'class="on"'; ?>>我的收藏</a> 
<a href="?c=comment" <?php if($c=='comment') echo 'class="on"'; ?>>我的评论</a> 
<a href="?c=order" <?php if($c=='order' or $c=='ordershow') echo 'class="on"'; ?>>我的订单</a> 
<a href="?c=msg" <?php if($c=='msg') echo 'class="on"'; ?>>我的留言</a> 
</div>
