...
<?php
			...
			//检测文档正确性
			$row = $dosql->GetOne("SELECT * FROM `#@__classadvice` WHERE id=$id");
			if(is_array($row))
			{
...
<table width="725" border="0" cellspacing="1" cellpadding="5" style="font-size: 12px;
                    ...
                    <tr>
                        <td colspan="4" align="center" style="background: #005288; color: #fff; font-family: Microsoft YaHei,Arial;
                            font-weight: bold; font-size: 14px; padding: 8px;">课程建议表<br />
					...
					<tr>
                        ...
                        <td width="252" bgcolor="#FFFFFF">
                         ...
                         <td width="105" align="center" bgcolor="#FFFFFF">
                            建议信息<span style="color:#ff0000; font-size:16px; font-weight:bolder; vertical-align:bottom">*</span>                        </td>
                        <td width="200" bgcolor="#FFFFFF">
                            <span style="color: #000000; padding-left: 8px;">
                               <?php echo $row['a8']; ?>
                          </span>
                    ...
                    <tr>
                        <td align="center" bgcolor="#FFFFFF">
                            添加日期<span style="color:#ff0000; font-size:16px; font-weight:bolder; vertical-align:bottom">*</span></td>
                        <td colspan="3" bgcolor="#FFFFFF">
                            <span style="color: #000000; padding-left: 8px;">
                                <?php echo $row['shijian']; ?>
                            </span>
                        </td>
                    </tr>
