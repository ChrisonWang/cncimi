...
<?php
				if(!empty($keyword))
				{
					...
					$dopage->GetPage("SELECT * FROM `#@__canzhan` ");
				}
				else
				{
					$dopage->GetPage("SELECT * FROM `#@__canzhan` ");
...
<td height="30" align="center"><a href="member8.php?id=<?php echo $row['id']; ?>">查看</a>&nbsp;/&nbsp;<a href="member9.php?id=<?php echo $row['id']; ?>">删除</a></td>
</tr><?php
				}
				?>
</table>
