...
<td height="30" align="center"><strong>所在城市</strong></td>
...
<?php
				if(!empty($keyword))
				{
					...
					$dopage->GetPage("SELECT * FROM `#@__yanjiang` ");
				}
				else
				{
					$dopage->GetPage("SELECT * FROM `#@__yanjiang` ");
...
<td height="30" align="center"><a href="member2.php?id=<?php echo $row['id']; ?>">查看</a>&nbsp;/&nbsp;<a href="member3.php?id=<?php echo $row['id']; ?>">删除</a></td>
</tr><?php
				}
				?>
</table>
