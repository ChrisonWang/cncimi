...
<table width="725" border="0" cellspacing="1" cellpadding="5" style="font-size: 12px;
                    ...
                    <tr>
                        <td colspan="4" align="center" style="background: #005288; color: #fff; font-family: Microsoft YaHei,Arial;
                            font-weight: bold; font-size: 14px; padding: 8px;">网站留言表<br />
                    ...
                    <tr>
                        <td align="center" bgcolor="#FFFFFF">
                            您对网站的建议<span style="color:#ff0000; font-size:16px; font-weight:bolder; vertical-align:bottom">*</span></td>
					...
					<tr>
                        <td align="center" bgcolor="#FFFFFF">
                            您对论坛的建议<span style="color:#ff0000; font-size:16px; font-weight:bolder; vertical-align:bottom">*</span></td>
                        <td colspan="3" bgcolor="#FFFFFF">
                            <span style="color: #000000; padding-left: 8px;">
                               <?php echo $row['a6']; ?>
                            </span>
